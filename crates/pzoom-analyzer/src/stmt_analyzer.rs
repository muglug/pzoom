...
use crate::stmt::{
    ...
    function_analyzer, if_analyzer, return_analyzer, switch_analyzer, try_analyzer, while_analyzer,
};
...
pub fn analyze_stmt(
    ...
    match stmt {
        ...
        Statement::If(if_stmt) => if_analyzer::analyze(analyzer, if_stmt, analysis_data, context),
        ...
        Statement::Block(block) => {
            analyze_stmts(analyzer, block.statements.as_slice(), analysis_data, context)
        }
        ...
        Statement::Interface(_) | Statement::Trait(_) | Statement::Enum(_) => Ok(()),
        ...
        Statement::For(for_stmt) => for_analyzer::analyze(analyzer, for_stmt, analysis_data, context),
        ...
        Statement::Global(_) => Ok(()),
        Statement::Static(_) => Ok(()),
        Statement::Unset(_) => Ok(()),
